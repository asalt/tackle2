...
class ParamsConfig(ConfigSection):
    ...
    __fields__ = {
        ...
        "volcanodir": FieldMeta(
            Union[str, List[str]],
            "",
            "One or more directories containing volcano TSV files.",
        ),
        "rankfiledir": FieldMeta(str, "savedir", "Where generated rank files are written; 'savedir' creates savedir/ranks."),
        "gct_path": FieldMeta(str, "", "Path to GCT file when ranks_from='gct' or 'model'."),
        ...
        "pathways_of_interest": FieldMeta(
            List[str],
            list,
            "Pathways that should be included in enrichment-plot selection when present.",
        ),
        "genesets": FieldMeta(
            List[Dict[str, Any]],
            _default_genesets,
